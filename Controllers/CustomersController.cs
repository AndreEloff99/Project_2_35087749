...
namespace Project_2_35087749.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CustomersController : ControllerBase
    {
        private readonly dbProject2_35087749devContext _context;

        public CustomersController(dbProject2_35087749devContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Customer>> PostCustomer(Customer customer)
        {
          if (_context.Customers == null)
          {
              return Problem("Entity set 'dbProject2_35087749devContext.Customers'  is null.");
          }
